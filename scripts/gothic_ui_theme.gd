...
static func build() -> Theme:
	...
	result.set_stylebox("panel", "GothicLootGroundPanel", _flat(Color(0.008, 0.007, 0.006, 0.82), Color(0.44, 0.34, 0.24, 0.88), 1, 5))
	result.set_type_variation("GothicLootRareGroundPanel", "Panel")
	result.set_stylebox("panel", "GothicLootRareGroundPanel", _flat(Color(0.07, 0.025, 0.012, 0.90), Color(0.78, 0.51, 0.24, 0.96), 2, 5))
	result.set_type_variation("GothicLootToastPanel", "Panel")
	result.set_stylebox("panel", "GothicLootToastPanel", _flat(Color(0.012, 0.010, 0.009, 0.93), Color(0.43, 0.32, 0.21, 0.92), 1, 8))
	result.set_type_variation("GothicLootErrorPanel", "Panel")
	result.set_stylebox("panel", "GothicLootErrorPanel", _flat(Color(0.105, 0.018, 0.014, 0.95), Color(0.67, 0.30, 0.21, 0.96), 2, 8))
	result.set_type_variation("GothicLootRareBanner", "Panel")
	result.set_stylebox("panel", "GothicLootRareBanner", _texture(COMPONENT_TITLE_BAR, Vector4(118, 58, 118, 58), 24))
