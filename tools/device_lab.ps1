[CmdletBinding()]
param(
    [ValidateSet('push', 'status', 'snapshot', 'reset_diagnostics', 'read_diagnostics', 'stop_diagnostics', 'repair_diagnostics', 'apply_ui_profile', 'export_player_state', 'ensure_chiyue_test_roster', 'apply_player_state', 'list_checkpoints', 'rollback_player_state', 'rollback_ui_profile', 'pull', 'screenshot')]
...
$documentActions = @('snapshot', 'reset_diagnostics', 'read_diagnostics', 'stop_diagnostics', 'repair_diagnostics', 'export_player_state', 'list_checkpoints')
if ($documentActions -contains $Action -and -not [string]::IsNullOrWhiteSpace($OutputPath)) {
    ...
    $document = switch ($Action) {
        ...
        'reset_diagnostics' { $result.performance_diagnostics; break }
        'read_diagnostics' { $result.performance_diagnostics; break }
        'stop_diagnostics' { $result.performance_diagnostics; break }
