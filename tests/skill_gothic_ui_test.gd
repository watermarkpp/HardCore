...
func _run() -> void:
	...
	assert(panel.get_node("AssignmentPanel/ClearAttackSkillSlot").theme_type_variation == "GothicSkillRestorePlainButton")
	assert(panel.get_node("AssignmentPanel/AttackRingSkillSlot_1").theme_type_variation == "GothicSkillRingPlainButton")
	assert(panel.get_node("AssignmentPanel/ClearAttackRingSkillSlot_1").theme_type_variation == "GothicSkillClearPlainButton")
	assert(panel.get_node("AssignmentPanel/AttackSkillSlot").theme_type_variation == "GothicSkillPrimaryPlainButton")
