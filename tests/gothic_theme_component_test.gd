...
func _ready() -> void:
	...
	for variation in ["GothicComponentButton", "GothicComponentSelectedButton", "GothicComponentTabButton", "GothicComponentSlotButton", "GothicComponentSelectedSlotButton", "GothicComponentShopCard", "GothicComponentCloseButton"]:
