...
func _ready() -> void:
	...
	assert(fireball.proficiency_event.is_empty())
	...
	assert(repulsion.proficiency_event.is_empty())
	...
	assert(temptation.proficiency_event.is_empty())
	...
	assert(hellfire.proficiency_event.is_empty())
	...
	assert(great_fireball.proficiency_event.is_empty())
	...
	assert(teleport.proficiency_event.is_empty())
	...
	assert(exploding.proficiency_event.is_empty())
	...
	assert(laser.proficiency_event.is_empty())
	...
	assert(hell_lightning.proficiency_event.is_empty())
	...
	assert(shield.proficiency_event.is_empty())
	...
	assert(holy_word.proficiency_event.is_empty())
	...
	assert(ice_storm.proficiency_event.is_empty())
