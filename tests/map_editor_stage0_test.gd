...
func _ready() -> void:
	...
	var orc_tomb_2_blank := MapEditorTypes.new_map_from_blank_template("blank.orc_tomb_2")
	var orc_tomb_3_blank := MapEditorTypes.new_map_from_blank_template("blank.orc_tomb_3")
	assert(orc_tomb_2_blank.design.design_size == [38, 38])
	assert(orc_tomb_3_blank.design.design_size == [38, 38])
	assert(orc_tomb_2_blank.design.strategy == "exact_clone_of_orc_tomb_1")
	assert(orc_tomb_3_blank.design.strategy == "exact_clone_of_orc_tomb_1")
	...
	editor._refresh_map_template_options("blank.orc_tomb_3")
