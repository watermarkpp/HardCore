...
- 固定构建提交：`551b21d8b19c1e62ac24b28d4dd8dc1ed6f780e0`；APK：`outputs/hardcore/HardCore-v64-spatial-projection-debug.apk`；大小 `244,568,111` 字节；SHA-256 `D4CB03DA88EAA2FD41F41E31FB575DE9EE8A9BCEB7F6BF134C0CA8F077D351E5`；版本 `64 / 1.18.1-spatial-projection`，v2/v3 签名和运行时资源探针通过。
