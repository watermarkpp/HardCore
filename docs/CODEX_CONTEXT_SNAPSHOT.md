...
更新时间：2026-07-28 23:26（Asia/Shanghai）
...
- 分支/运行时代码基线：`codex/integration` @ `50e10061`（本次快照提交只改本文档）。
...
| `HardCore-worktrees/equipment` | `codex/equipment` @ `ac743c73` | 4 个既有 monster import 修改及 UID/生成项继续保护 | 146/147/149 校准预览均直接挂载原始RGBA并只使用非破坏显示变换；146/147用户草稿保持冻结，正式游戏素材未烘焙，继续等待其他头盔全部校准后统一接入 |
