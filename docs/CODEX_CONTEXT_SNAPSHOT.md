...
更新时间：2026-07-28 22:24（Asia/Shanghai）
...
- 分支/运行时代码基线：`codex/integration` @ `12601d14`（本次快照提交只改本文档）。
...
| `HardCore-worktrees/equipment` | `codex/equipment` @ `b027ed66` | 4 个既有 monster import 修改及 UID/生成项继续保护 | 校准工具 0.5px 微调与鼠标旁右键缩放菜单已集成；146 用户草稿保持冻结，正式游戏素材未烘焙，继续等待其他头盔全部校准后统一接入 |
